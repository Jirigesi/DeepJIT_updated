...
def splitData(commit_infor_file: str, original_file: str, OS_threshold_dict:dict):
    ...
    file1name = "splittedData/easy_OR_" + original_file.split('/')[-1]
    ...
    file2name = "splittedData/hard_OR_" + original_file.split('/')[-1]
...
if __name__ == "__main__":
    ...
    for idx, datatype in enumerate(dataType):
        ...
        splitData(commit_infor_file[idx], original_file[idx], OS_threshold_dict)
